...
public class Demo {
	 ...
	 * Both hosts will use the ping-pong protocol demoed in reso.examples.pingpong.
	 ...
	 * the ping-pong protcol example (see reso.examples.pingpong).
	 */
	public static void main(String [] args)
	{
		...
		try {
    		...
    		new Link<EthernetFrame>((EthernetInterface) host1.getInterfaceByName("eth0"),
    				(EthernetInterface) router.getInterfaceByName("eth0"), 5000000);
    		new Link<EthernetFrame>((EthernetInterface) router.getInterfaceByName("eth1"),
    				(EthernetInterface) host2.getInterfaceByName("eth0"), 5000000);
