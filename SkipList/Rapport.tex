...
\begin{document}
	...
	%% TODO: Clarifier. Un lecteur lambda ne comprends pas que ça sert à stocker des données.
	...
	Tout comme un dictionnaire, une skip-list permet de récupérer la définition d'un terme recherché \textit{(dit clé)}. Cette recherche est rapide, car les éléments présents dans un dictionnaire sont triés. 
	...
	\begin{center}
		\includegraphics[width=\textwidth]{img/struct} %% TODO: Changer niveau par couche
	\end{center}
