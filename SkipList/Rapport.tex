...
\begin{document}
	...
	Comment rechercher l'élément 8 dans la liste suivante?
	\begin{figure}[h]
		\includegraphics[width=\textwidth]{img/search}
		\caption{Recherche dans une skip-liste}
		\label{SkipSearch1}
	\end{figure}
	...
	\begin{itemize}
		...
		\item 8 est-il l'élément recherché? Oui, la recherche est concluante.
	\end{itemize}
